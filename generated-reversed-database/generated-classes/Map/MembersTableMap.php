...
class MembersTableMap extends TableMap
{
     ...
     */
    const COL_FIRSTNAME = 'members.firstname';

    /**
     * the column name for the surname field
     */
    const COL_SURNAME = 'members.surname';
     ...
     */
    const COL_GENDER = 'members.gender';

    /**
     * the column name for the joined_date field
     */
    const COL_JOINED_DATE = 'members.joined_date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Firstname', 'Surname', 'Email', 'Gender', 'JoinedDate', ),
        self::TYPE_CAMELNAME     => array('id', 'firstname', 'surname', 'email', 'gender', 'joinedDate', ),
        self::TYPE_COLNAME       => array(MembersTableMap::COL_ID, MembersTableMap::COL_FIRSTNAME, MembersTableMap::COL_SURNAME, MembersTableMap::COL_EMAIL, MembersTableMap::COL_GENDER, MembersTableMap::COL_JOINED_DATE, ),
        self::TYPE_FIELDNAME     => array('id', 'firstname', 'surname', 'email', 'gender', 'joined_date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Firstname' => 1, 'Surname' => 2, 'Email' => 3, 'Gender' => 4, 'JoinedDate' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firstname' => 1, 'surname' => 2, 'email' => 3, 'gender' => 4, 'joinedDate' => 5, ),
        self::TYPE_COLNAME       => array(MembersTableMap::COL_ID => 0, MembersTableMap::COL_FIRSTNAME => 1, MembersTableMap::COL_SURNAME => 2, MembersTableMap::COL_EMAIL => 3, MembersTableMap::COL_GENDER => 4, MembersTableMap::COL_JOINED_DATE => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'firstname' => 1, 'surname' => 2, 'email' => 3, 'gender' => 4, 'joined_date' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('gender', 'Gender', 'VARCHAR', false, 50, null);
        $this->addColumn('joined_date', 'JoinedDate', 'DATE', false, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MembersTableMap::COL_FIRSTNAME);
            $criteria->addSelectColumn(MembersTableMap::COL_SURNAME);
            $criteria->addSelectColumn(MembersTableMap::COL_EMAIL);
            $criteria->addSelectColumn(MembersTableMap::COL_GENDER);
            $criteria->addSelectColumn(MembersTableMap::COL_JOINED_DATE);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.joined_date');
        }
    }
