 ...
 * @method     ChildMembersQuery orderByFirstname($order = Criteria::ASC) Order by the firstname column
 * @method     ChildMembersQuery orderBySurname($order = Criteria::ASC) Order by the surname column
 * @method     ChildMembersQuery orderByEmail($order = Criteria::ASC) Order by the email column
 * @method     ChildMembersQuery orderByGender($order = Criteria::ASC) Order by the gender column
 * @method     ChildMembersQuery orderByJoinedDate($order = Criteria::ASC) Order by the joined_date column
 *
 * @method     ChildMembersQuery groupById() Group by the id column
 * @method     ChildMembersQuery groupByFirstname() Group by the firstname column
 * @method     ChildMembersQuery groupBySurname() Group by the surname column
 * @method     ChildMembersQuery groupByEmail() Group by the email column
 * @method     ChildMembersQuery groupByGender() Group by the gender column
 * @method     ChildMembersQuery groupByJoinedDate() Group by the joined_date column
 *
 ...
 * @method     ChildMembers findOneByFirstname(string $firstname) Return the first ChildMembers filtered by the firstname column
 * @method     ChildMembers findOneBySurname(string $surname) Return the first ChildMembers filtered by the surname column
 * @method     ChildMembers findOneByEmail(string $email) Return the first ChildMembers filtered by the email column
 * @method     ChildMembers findOneByGender(string $gender) Return the first ChildMembers filtered by the gender column
 * @method     ChildMembers findOneByJoinedDate(string $joined_date) Return the first ChildMembers filtered by the joined_date column *
 ...
 * @method     ChildMembers requireOneByFirstname(string $firstname) Return the first ChildMembers filtered by the firstname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildMembers requireOneBySurname(string $surname) Return the first ChildMembers filtered by the surname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildMembers requireOneByGender(string $gender) Return the first ChildMembers filtered by the gender column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildMembers requireOneByJoinedDate(string $joined_date) Return the first ChildMembers filtered by the joined_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildMembers[]|ObjectCollection findByFirstname(string $firstname) Return ChildMembers objects filtered by the firstname column
 * @method     ChildMembers[]|ObjectCollection findBySurname(string $surname) Return ChildMembers objects filtered by the surname column
 * @method     ChildMembers[]|ObjectCollection findByEmail(string $email) Return ChildMembers objects filtered by the email column
 * @method     ChildMembers[]|ObjectCollection findByGender(string $gender) Return ChildMembers objects filtered by the gender column
 * @method     ChildMembers[]|ObjectCollection findByJoinedDate(string $joined_date) Return ChildMembers objects filtered by the joined_date column
...
abstract class MembersQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, firstname, surname, email, gender, joined_date FROM members WHERE id = :p0';
        try {
    ...
    public function filterByFirstname($firstname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(MembersTableMap::COL_FIRSTNAME, $firstname, $comparison);
    }
    ...
    public function filterBySurname($surname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(MembersTableMap::COL_SURNAME, $surname, $comparison);
    }
    ...
    public function filterByGender($gender = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(MembersTableMap::COL_GENDER, $gender, $comparison);
    }

    /**
     * Filter the query on the joined_date column
     *
     * Example usage:
     * <code>
     * $query->filterByJoinedDate('2011-03-14'); // WHERE joined_date = '2011-03-14'
     * $query->filterByJoinedDate('now'); // WHERE joined_date = '2011-03-14'
     * $query->filterByJoinedDate(array('max' => 'yesterday')); // WHERE joined_date > '2011-03-13'
     * </code>
     *
     * @param     mixed $joinedDate The value to use as filter.
     ...
     * @return $this|ChildMembersQuery The current query, for fluid interface
     */
    public function filterByJoinedDate($joinedDate = null, $comparison = null)
    {
        if (is_array($joinedDate)) {
            $useMinMax = false;
            if (isset($joinedDate['min'])) {
                $this->addUsingAlias(MembersTableMap::COL_JOINED_DATE, $joinedDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($joinedDate['max'])) {
                $this->addUsingAlias(MembersTableMap::COL_JOINED_DATE, $joinedDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MembersTableMap::COL_JOINED_DATE, $joinedDate, $comparison);
    }
