...
abstract class Members implements ActiveRecordInterface
{
    ...
    /**
     * The value for the joined_date field.
     *
     * @var        DateTime
     */
    ...
    /**
     * Get the [optionally formatted] temporal [joined_date] column value.
     *
     *
     ...
     */
    public function getJoinedDate($format = NULL)
    {
        if ($format === null) {
            return $this->joined_date;
        } else {
            return $this->joined_date instanceof \DateTimeInterface ? $this->joined_date->format($format) : null;
        }
    }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[MembersTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setSurname($v)
    {
        ...
        if ($this->surname !== $v) {
            $this->surname = $v;
            $this->modifiedColumns[MembersTableMap::COL_SURNAME] = true;
        }
    ...
    public function setGender($v)
    {
        ...
        if ($this->gender !== $v) {
            $this->gender = $v;
            $this->modifiedColumns[MembersTableMap::COL_GENDER] = true;
        }
    ...
    /**
     * Sets the value of [joined_date] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Members The current object (for fluent API support)
     */
    public function setJoinedDate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->joined_date !== null || $dt !== null) {
            if ($this->joined_date === null || $dt === null || $dt->format("Y-m-d") !== $this->joined_date->format("Y-m-d")) {
                $this->joined_date = $dt === null ? null : clone $dt;
                $this->modifiedColumns[MembersTableMap::COL_JOINED_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MembersTableMap::translateFieldName('Surname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->surname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MembersTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MembersTableMap::translateFieldName('Gender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gender = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MembersTableMap::translateFieldName('JoinedDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->joined_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = MembersTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MembersTableMap::COL_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'firstname';
        }
        if ($this->isColumnModified(MembersTableMap::COL_SURNAME)) {
            $modifiedColumns[':p' . $index++]  = 'surname';
        }
        if ($this->isColumnModified(MembersTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(MembersTableMap::COL_GENDER)) {
            $modifiedColumns[':p' . $index++]  = 'gender';
        }
        if ($this->isColumnModified(MembersTableMap::COL_JOINED_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'joined_date';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'gender':
                        ...
                        break;
                    case 'joined_date':
                        $stmt->bindValue($identifier, $this->joined_date ? $this->joined_date->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MembersTableMap::COL_FIRSTNAME)) {
            $criteria->add(MembersTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(MembersTableMap::COL_SURNAME)) {
            $criteria->add(MembersTableMap::COL_SURNAME, $this->surname);
        }
        if ($this->isColumnModified(MembersTableMap::COL_EMAIL)) {
            $criteria->add(MembersTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(MembersTableMap::COL_GENDER)) {
            $criteria->add(MembersTableMap::COL_GENDER, $this->gender);
        }
        if ($this->isColumnModified(MembersTableMap::COL_JOINED_DATE)) {
            $criteria->add(MembersTableMap::COL_JOINED_DATE, $this->joined_date);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setJoinedDate($this->getJoinedDate());
        if ($makeNew) {
            $copyObj->setNew(true);
        }
    }
